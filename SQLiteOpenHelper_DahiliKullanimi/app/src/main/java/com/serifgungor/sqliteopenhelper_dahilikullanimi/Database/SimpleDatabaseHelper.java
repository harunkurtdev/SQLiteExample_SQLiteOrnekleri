package com.serifgungor.sqliteopenhelper_dahilikullanimi.Database;
...
public class SimpleDatabaseHelper {
    ...
    class SimpleSQLiteOpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("create table if not exists notlar (id integer primary key autoincrement, baslik varchar(255), tarih varchar(255), aciklama text)");
            db.execSQL("insert into notlar (baslik,tarih,aciklama) values ('başlık','09.01.2019','açıklama')");


            //Veritabanı tablosu üretebilmek için onCreate metodu içerisinde sorgu yazılır.
            //primary key - değerin benzersiz ve birincil anahtar olması
            //autoincrement - sayılarda kullanılır, primary key'în otomatik artmasını sağlar.
            //if not exits ise - eğer yoksa demektir.
